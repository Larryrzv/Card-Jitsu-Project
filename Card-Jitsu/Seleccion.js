...
// Clases
class Ninjas{
    constructor(nombre, foto, clase, vida,) {
        this.nombre = nombre
        this.foto = foto
        this.clase = clase
        this.vida = vida
...
let ninjaAgua = new Ninjas("NinjaAgua", "./resources/ninjaDeAgua.png", "tarjetaDeAgua", 3)
let ninjaFuego = new Ninjas("NinjaFuego", "./resources/ninjaDeFuego.png", "tarjetaDeFuego", 3)
let ninjaNieve = new Ninjas("NinjaNieve", "./resources/ninjaDeNieve.png", "tarjetaDeNieve", 3)
